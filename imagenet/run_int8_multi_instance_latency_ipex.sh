...
### How to run?
### 1) int8 inference
###    bash run_int8_multi_instance_latency_ipex.sh resnet50 DATA_PATH dnnl int8 jit resnet50_configure_jit.json
### 2) fp32 infenence
###    bash run_int8_multi_instance_latency_ipex.sh resnet50 DATA_PATH dnnl fp32 jit
###
###############################################################################
